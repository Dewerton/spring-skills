...
Usage:
    python3 amplicode_mcp.py <tool_name> [key=value ...]
...
Examples:
    python3 amplicode_mcp.py get_project_summary projectPath=/my/project
    python3 amplicode_mcp.py list_project_endpoints projectPath=/my/project
    python3 amplicode_mcp.py get_endpoint_info projectPath=/my/project httpMethod=POST fullUrl=/rest/investment/structured/{id}/optimize-quantity
    python3 amplicode_mcp.py list_all_domain_entities projectPath=/my/project regexPattern=Bond
    python3 amplicode_mcp.py analyze_files projectPath=/my/project files='["src/main/java/Foo.java"]'
    python3 amplicode_mcp.py rebuild_project projectPath=/my/project rebuild=true
    python3 amplicode_mcp.py run_tests projectPath=/my/project onlyFailed=true
    python3 amplicode_mcp.py --list
